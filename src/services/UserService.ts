export class UserService {
    ...
    static joinUser(id: string, username: string, room: string, isSupport:boolean, supportId?:string) {
        const user: IChatUser = {
            socketId: id, username: username, room: room, isSupport:isSupport, supportId
        }
